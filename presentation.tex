...
\vspace{0.2cm}
\begin{itemize}
    \item[\textcolor{blue}{\textbf{→}}] \textbf{Ansible-centered automation} drives reliability and team agility
    \vspace{0.5em}
    
    \item[\textcolor{blue}{\textbf{→}}] \textbf{Agile practices} enhance automation sustainability
    \vspace{0.5em}
    
    \item[\textcolor{blue}{\textbf{→}}] \textbf{Cross-functional collaboration} accelerates delivery
    \vspace{0.5em}
    
    \item[\textcolor{blue}{\textbf{→}}] \textbf{Continuous improvement} ensures long-term success
\end{itemize}
\vspace{0.2cm}
\end{block}
