...
\begin{itemize}
    ...
    \begin{itemize}
        \textit{Ensuring the reliability, performance, and security of critical systems and services.}
    \end{itemize}
\end{itemize}
\end{frame}
...
\begin{tcolorbox}[colframe=cyan!30, colback=white, arc=3mm, boxrule=0.6pt,
  ...
  \vspace{0.4em}
  Motivate \textbf{cross-functional teamwork} to accelerate delivery through automation.
\end{tcolorbox}
\end{frame}
